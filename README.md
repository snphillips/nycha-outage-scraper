...
- You will need the following python packages installed: *requests, bs4, datetime, pytz, csv, pathlib, pandas & lxml.*  These are all listed in requirements.txt.  To install those packages, in your terminal run:

`pip3 install -r requirements.txt`

(Those packages will take about 30 seconds to install)
