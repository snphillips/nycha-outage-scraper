...
CurrentHeatHotWaterWaterOutages = {
  'CsvSuffix': '/heathotwatercurrentoutage.csv',
...
RestoredHeatHotWaterWaterOutages = {
  'CsvSuffix': '/heathotwatercurrentoutage.csv',
...
PlannedHeatHotWaterWaterOutages = {
  'CsvSuffix': '/heathotwaterplannedoutages.csv',
...
class ElectricCurrentOutages:
  CsvSuffix = '/electriccurrentoutage.csv'
